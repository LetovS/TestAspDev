...
public static class DatabaseMigrationManager
{
        ...
        where TDbContextFactory : IDesignTimeDbContextFactory<TDbContext>, new()
    {
        ...
        await dbContext.Database.ExecuteSqlRawAsync("INSERT INTO public.\"Questions\" (\"Id\",\"Question\",\"Type\",\"SurveyRecordId\") VALUES " +
        ...
        await dbContext.Database.ExecuteSqlRawAsync("INSERT INTO public.\"Interviews\" (\"Id\",\"InterviewDate\",\"SurveyRecordId\") VALUES " +
            "('6e33a3f8-1201-4e12-b919-f72a0a1c318e','2024-02-28 00:00:00+03','82b6e4f5-5830-4a8d-9e17-6b49c9fb7e4f');");

        await dbContext.Database.ExecuteSqlRawAsync("INSERT INTO public.\"Answers\" (\"Id\",\"Answer\",\"QuestionRecordId\") VALUES " +
